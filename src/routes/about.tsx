...
import hostPhoto from "@/assets/host-james-worquea.jpg.asset.json";
    ...
    <Layout>
      ...
      <div className="about-section">
        <div className="about-content">
          ...
          <p>The Liberian Business Hour is a weekly radio program that airs every Saturday from 7:00 to 7:45 AM in Monrovia, Liberia. For those who miss the live broadcast, the show repeats every Sunday from 5:00 to 5:45 PM on the same station.</p>
          ...
          <div className="host-card">
            ...
            <div>
              ...
              <p>James T. Worquea III is a Liberian business journalist, radio host, and economic commentator. As the host and executive producer of The Liberian Business Hour, he has established himself as one of Liberia's most respected voices on business and economic affairs.</p>
